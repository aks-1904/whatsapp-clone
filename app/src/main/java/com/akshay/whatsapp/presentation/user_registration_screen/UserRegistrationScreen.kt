package com.akshay.whatsapp.presentation.user_registration_screen
...
fun UserRegistrationScreen() {
    ...
    Column(
        ...
        Row {
            Text(text = "Whatsapp need to verify your number")
        ...
        DropdownMenu(
            ...
            listOf("USA", "Japan", "China", "India").forEach { country ->
                DropdownMenuItem(
